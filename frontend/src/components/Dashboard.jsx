      ...
      <header className="bg-slate-950 border-b border-slate-700 sticky top-0 z-50">
        <div className="w-full px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            {/* Sağ Tarafta UserMenu ve Durum Bilgisi */}
            <div className="flex items-center gap-4">
              <div className="hidden md:block px-3 py-1 bg-green-500/20 text-green-300 rounded-full text-sm border border-green-500/30">
                ✓ Servislere Bağlı
              </div>
